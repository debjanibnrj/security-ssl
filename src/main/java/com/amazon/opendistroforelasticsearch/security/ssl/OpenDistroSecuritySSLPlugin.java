...
public class OpenDistroSecuritySSLPlugin extends Plugin implements ActionPlugin, NetworkPlugin {
    ...
    public List<Setting<?>> getSettings() {
        ...
        settings.add(Setting.listSetting(SSLConfigConstants.OPENDISTRO_SECURITY_AUTHCZ_ADMIN_DN, Collections.emptyList(), Function.identity(), Property.NodeScope));
        settings.add(Setting.listSetting(SSLConfigConstants.OPENDISTRO_SECURITY_NODES_DN, Collections.emptyList(), Function.identity(), Property.NodeScope));
        return settings;
    }
